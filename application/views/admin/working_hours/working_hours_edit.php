...
<?php $this->load->view('admin/includes/nav'); ?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex justify-content-between align-items-center">
            <h6 class="m-0 font-weight-bold text-warning">Working Hours Title Update List</h6>
        ...
        <div class="card-body">
            ...
            <br>
            <h3 class="text-center text-white bg-warning py-2 rounded">Working Hours Update</h3>
            <br>

            <form action="<?php echo base_url('Working_Hours_Edit_Act'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="col-sm-8 mb-2">
                                    ...
                                    <input type="text" name="w_hours_p_text" class="form-control" id="h1_text" placeholder="Iş saatlarımız" value="<?php echo $get_w_hours_edit['w_hours_p_text']; ?>">
                                </div>
                                <div class="col-sm-12 mb-2">
                                    <input type="text" name="w_hours_h1_text" class="form-control" id="h2_text" placeholder="H1 Text" value="<?php echo $get_w_hours_edit['w_hours_h1_text']; ?>">
                                </div>
                            </div>
                        </div>
                    </div>
