...
<?php $this->load->view('admin/includes/nav'); ?>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <h3 class="bg-primary text-center text-white mb-3 py-2 rounded"><b>Price</b></h3>
            <form action="<?php echo base_url('Price_Create_Act'); ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-8">
