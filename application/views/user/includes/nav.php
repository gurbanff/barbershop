...
<nav class="navbar navbar-expand-lg bg-secondary navbar-dark sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
    <?php foreach($nav_logo_all_data as $item){ ?>
        <a href="<?php echo $item['file_href']; ?>" class="navbar-brand ms-4 ms-lg-0">
            <!-- <h1 class="mb-0 text-primary text-uppercase">XL-BARBERSHOP</h1> -->
            <img style="width: 90px; height: 90px !important" src="<?php echo base_url('uploads/admin/navbar/') . $item['file']; ?>">
        </a>
    <?php } ?>
